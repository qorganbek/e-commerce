# Generated by Django 4.1.6 on 2023-04-10 02:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seller_product', models.ForeignKey(limit_choices_to={'is_active': True}, on_delete=django.db.models.deletion.PROTECT, related_name='order_item', to='seller_products.sellerproduct')),
            ],
        ),
    ]
